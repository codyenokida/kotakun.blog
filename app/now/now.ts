...
export const NOW_DATA = [
  ...
  },
  {
    ...
    location: "Irvine, CA 🇺🇸",
    currently:
      "Studying for some interviews. Writing content for this blog. Worked on a hackathon recently! Going to Taiwan and Japan next month so stoked and working on building out projects before then!",
    dayJob: "Not Applicable",
    interests: [
      "Reading",
      "Philosophy",
